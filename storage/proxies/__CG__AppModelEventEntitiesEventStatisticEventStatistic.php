...
namespace DoctrineProxies\__CG__\App\Model\Event\Entities\EventStatistic;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class EventStatistic extends \App\Model\Event\Entities\EventStatistic\EventStatistic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'event', 'total', 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventStatistic $proxy) {
